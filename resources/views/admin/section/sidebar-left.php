...
<!--                <h6 class="collapse-header">Custom Components:</h6>-->
                ...
                <a class="collapse-item active" href="cards.html">Add User</a>
            </div>
        </div>
    </li>
    <li class="nav-item active">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseCate" aria-expanded="true" aria-controls="collapseCate">
            <i class="fas fa-fw fa-cog"></i>
            <span>Category</span>
        </a>
        <div id="collapseCate" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <!--                <h6 class="collapse-header">Custom Components:</h6>-->
                <a class="collapse-item" href="buttons.html">List Category</a>
                <a class="collapse-item active" href="cards.html">Add Category</a>
            </div>
        </div>
    </li>
    <li class="nav-item active">
        ...
        <div id="collapseProduct" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="cards.html">Add Product</a>
            </div>
        </div>
    </li>
