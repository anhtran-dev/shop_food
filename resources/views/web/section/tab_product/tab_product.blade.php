<section class="product-tab pt-60 pt-md-30 pt-sm-30 pb-30">
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade active show" id="tab_one">
                        <div class="product-tab-wrapper">
                            <div class="row product-carousel-active slick-arrow-style">
                                <div class="col">
                                ...
                                <div class="col">
                                    <div class="product-item mb-50">
                                        ...
                                        <div class="product-content text-center">
                                            ...
                                            <div class="product-name">
                                                <h4 class="h5">
                                                    <a href="product-details.html">tazza vegetables</a>
                                                </h4>
                                            </div>
                                            <div class="price-box">
                                                <span class="regular-price">$110.00</span>
